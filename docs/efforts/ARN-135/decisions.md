...
Decision: Make app publication resolve the repository-scoped commit key used by Git ingestion, with a repository-checked legacy lookup and validation of both raw-SHA and scoped-Id field representations.
