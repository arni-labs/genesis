...
/// Hard page cap: 4 pages * 500 rows = 2000 refs per repository. A
/// repo beyond that needs the paging follow-up recorded in RFC-0004,
/// not a silent partial answer — callers error past the cap.
